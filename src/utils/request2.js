...
const request = axios.create({
  baseURL: process.env.NODE_ENV !== 'production' ? process.env.VUE_APP_BASE_ELSE_API : process.env.VUE_APP_SERVER_ELSE_URL,
...
request.interceptors.request.use(config => {
  ...
  // }
  // 在发送请求之前做些什么
  config.headers.Authorization = process.env.VUE_APP_ELSE_TOKEN
  return config;
}, function (error) {
  // 处理请求错误
