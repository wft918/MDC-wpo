...
<template>
  <div id="box" :style="{ width:lay_out == 'zhui'?maxWidth:lay_out == 'wpo'?'100%':maxWidth}">
    ...
    <div class="content">
      <div class="part">
        <left @showDialog="showDialog"></left>
      </div>
      <div class="parts">
        <center></center>
      </div>
...
<script>
  ...
  import left from '@/views/page/bigView/left/left'
  import center from '@/views/page/bigView/center/center'
  import right from '@/views/page/bigView/right/right'
  ...
  export default {
    ...
    methods: {
      // 报警列表弹窗显示
      showDialog(data) {
        this.$refs.AlarmDialog.init(data)
      },
