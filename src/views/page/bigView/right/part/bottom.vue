...
<template>
  <div class="box">
    ...
    <div class="content">
      <bar :areaData='areaData'></bar>
    </div>
  </div>
</template>
<script>
  import bar from '@/views/page/bigView/right/echarts/bar'
  // import { getareaperson } from '@/api/safetySupervision'
  import { areaPerson } from '@/api/bigView2'
  export default {
    components: {
      bar
    },
