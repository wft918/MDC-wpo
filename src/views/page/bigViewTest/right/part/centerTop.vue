...
<template>
  <div class="box">
    <div class="part">
      <p class="title">本月风险管控类别评估</p>
      <div class="content">
        <div style="height: 100%;width: 100%;padding-top: .052083rem /* 10/192 */;padding-left: .104167rem;padding-right: .104167rem;box-sizing: border-box;">
          <radar-echarts :radarData="radarData"></radar-echarts>
        </div>
      </div>
    </div>
    <div class="part">
      <p class="title">风险实时监测</p>
      <div class="content">
        <div
          ...
          <div style="width: 40%;height: 100%;padding-left: .026042rem;box-sizing: border-box;">设备区域/时间</div>
          <div style="width: 30%;height: 100%;padding-left: .078125rem;box-sizing: border-box;">告警类型</div>
          <div style="width: 30%;height: 100%;padding-left: .078125rem;box-sizing: border-box;">告警等级</div>
        </div>
...
<script>
  import radarEcharts from '@/views/page/bigViewTest/right/echarts/radarEcharts'
